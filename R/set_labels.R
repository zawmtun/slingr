#' Add `label` attribute to columns in a dataframe
#'
#' @param .data A dataframe.
#' @param .cols A character vector. Colomns to add labels.
...
#' }
#' @export
set_labels <- function(.data, .cols, .labels = NULL) {
  stopifnot(
